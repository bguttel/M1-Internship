...
#    total_period = math.ceil(period_in_time * saw_velocity / ((period[0] + period[1])/2))
...
def createMarks(nx = 4,
    ...
    # Make array
#    mkar = gds.CellArray(crmk, nx+1, ny//2+1, (dx,dy*2), origin=(-dx*nx/2, -dy*ny/2))
    mkar = gds.CellArray(crmk, nx+1, 5, (dx,2000), origin=(-4000, -4000))
...
def idt_20190407():
    ...
    """
    dx = 2000   # distance between set of IDTs [um]
    dy = 600    # distance between set of IDTs [um]
    nx = 4
    ny = 16
    ...
    types1 = np.array( [ 
              [2,10,11,10,2,10,11,10,2,10,11,10,2,10,11,10], # single finger and "special" double finger
              [2,10,2,10,2,10,2,10,2,10,2,10,2,10,2,10], # split 52
              [2,10,11,10,2,10,11,10,2,10,11,10,2,10,11,10], # 
              [2,10,2,10,2,10,2,10,2,10,2,10,2,10,2,10]  # split 4 and "special" IDTs
            ])
    
    types2 = np.array( [ 
              [2,11,10,2,2,11,10,2,2,11,10,2,2,11,10,2], # single finger and "special" double finger
              [2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2], # split 52
              [2,11,10,2,2,11,10,2,2,11,10,2,2,11,10,2], # 
              [2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2]  # split 4 and "special" IDTs
            ])
    
    wavelengths = np.array( [ 
              [2,2,2,2,1,1,1,1,2,2,2,2,1,1,1,1],
              [0.5,0.5,0.75,0.75,1.0,1.0,2.0,2.0,0.5,0.5,0.75,0.75,0.5,0.5,0.75,0.75],
              [2,2,2,2,1,1,1,1,1,1,1,1,2,2,2,2],
              [0.5,0.5,0.75,0.75,0.5,0.5,0.75,0.75,0.5,0.5,0.75,0.75,1,1,2,2]
            ]) #[um]
    
#    periods_in_time = np.array( [ 
#              [20,20,20,20,20,20,20,20,40,40,40,40,40,40,40,40],
#              [60,60,60,60,60,60,60,60,40,40,40,40,20,20,20,20],
#              [40,40,40,40,40,40,40,40,20,20,20,20,20,20,20,20],
#              [40,40,40,40,20,20,20,20,60,60,60,60,60,60,60,60]
#            ]) #[ns]
...
#    top.add(gds.Rectangle((-dx*nx/2-space, -dy*ny/2-space),(dx*nx/2+space, dy*ny/2+space), layer=4, datatype=0))
    ...
    saveCell2GDS(pattern, 'idt_20190407b')
